// src/components/admin/MemoCreateModal.tsx
"use client";
...
interface MemoCreateModalProps {
  isOpen: boolean;
  onClose: () => void;
  memoData: { type: string; content: string };
  setMemoData: React.Dispatch<React.SetStateAction<{ type: string; content: string }>>;
  onSave: () => void;
}

export default function MemoCreateModal({ isOpen, onClose, memoData, setMemoData, onSave }: MemoCreateModalProps) {
