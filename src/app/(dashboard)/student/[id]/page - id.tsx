      ...
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm overflow-x-auto">
        <div className="flex justify-between items-end mb-6 min-w-[500px]">
          ...
          <div className="flex gap-3">
            <span className="text-[11px] font-bold text-slate-500 flex items-center gap-1.5"><div className="w-3 h-3 bg-[#002864] rounded-sm"></div>최초 점수 (O)</span>
            <span className="text-[11px] font-bold text-slate-500 flex items-center gap-1.5"><div className="w-3 h-3 bg-blue-300 rounded-sm"></div>최종 점수 (+RO, TO)</span>
          </div>
        </div>
        <svg viewBox={`0 0 ${width} ${height}`} className="w-full h-auto min-w-[500px]">
          {/* Y축 배경선 */}
                 ...
                 <div key={i} className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between hover:border-blue-300 transition-colors">
                   ...
                   <div className="flex justify-between items-center bg-slate-50 p-2.5 rounded-lg border border-slate-100 mb-3">
                     <div className="flex flex-col items-center flex-1">
                        <span className="text-[10px] font-bold text-slate-400 mb-0.5">최초 (O만)</span>
                        <span className="text-[15px] font-black text-[#002864]">{initial}점</span>
                     </div>
                     <div className="text-slate-300 font-bold text-lg">➔</div>
                     <div className="flex flex-col items-center flex-1">
                        <span className="text-[10px] font-bold text-slate-400 mb-0.5">클리닉 후 최종</span>
                        <span className="text-[15px] font-black text-blue-600">{final}점</span>
                     </div>
                   </div>
